...
exports.AppModule = AppModule = __decorate([
    (0, common_1.Module)({
        imports: [prisma_module_1.PrismaModule, enumerator_module_1.EnumeratorModule],
        controllers: [app_controller_1.AppController, submission_controller_1.SubmissionController],
        providers: [app_service_1.AppService, prisma_service_1.PrismaService, submission_service_1.SubmissionService],
    })
], AppModule);
